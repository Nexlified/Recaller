...
class MCPServerSettings(BaseSettings):
    ...
    MODEL_REGISTRY_PATH: str = Field(default="./model_configs", description="Path to model registry")
    ...
    DEFAULT_HUGGINGFACE_CACHE: Optional[str] = Field(default="./model_configs/huggingface", description="Default HuggingFace cache directory")
