...
class Contact(Base):
    ...
    organization = relationship("Organization", foreign_keys=[organization_id], back_populates="contacts")
    interactions = relationship("ContactInteraction", back_populates="contact", cascade="all, delete-orphan")
    task_contacts = relationship("TaskContact", back_populates="contact")
